...
public class RestApi extends RouteBuilder {
    ...
    public void configure() throws Exception {
        restConfiguration()
                .bindingMode(RestBindingMode.json).bindingPackageScan("au.id.wattle.chapman.camel.demo.models");
        rest().openApi().specification("swagger.yml").missingOperation("ignore");
